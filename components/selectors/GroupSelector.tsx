...
interface GroupSelectorProps {
  ...
  onChangeAction: (groupId: string) => void;
}

// Simplified GroupSelector that doesn't use complex ref patterns
function GroupSelector({ groups, selectedGroupId, onChangeAction }: GroupSelectorProps) {
  ...
  return (
    <div className="max-w-xs">
      ...
      <SelectPrimitive.Root value={selectedGroupId || ""} onValueChange={handleValueChange}>
        ...
        >
          <SelectPrimitive.Value placeholder="Select Group" />
          ...
          >
            <SelectPrimitive.Viewport className="p-1">
              {groups.map((group) => (
                ...
                >
                  <SelectPrimitive.ItemText>{group.name}</SelectPrimitive.ItemText>
